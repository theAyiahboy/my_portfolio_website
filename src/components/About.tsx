    ...
    <section id="about" className="py-28 bg-gradient-to-b from-primary-900 via-primary-800 to-primary-900 text-primary-100">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-20 items-center">
        ...
        <div className="flex flex-col items-center md:items-start bg-primary-800 rounded-2xl shadow-2xl p-10 border-2 border-accent relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-10 bg-primary-900 flex items-center px-4 gap-2 border-b border-accent">
          ...
          <img
            ...
            className="w-36 h-36 rounded-full object-cover border-4 border-accent shadow-lg mt-12 mb-6"
          />
          <h2 className="text-2xl font-bold text-accent mb-1 font-mono">Giovanni Ayiah-Mensah</h2>
          ...
          <div className="flex flex-wrap gap-2 mb-2">
            <span className="bg-accent/10 text-accent px-3 py-1 rounded-full text-xs font-semibold font-mono border border-accent/30">Python</span>
            <span className="bg-accent/10 text-accent px-3 py-1 rounded-full text-xs font-semibold font-mono border border-accent/30">Prompt Engineering</span>
            <span className="bg-accent/10 text-accent px-3 py-1 rounded-full text-xs font-semibold font-mono border border-accent/30">Git</span>
            <span className="bg-accent/10 text-accent px-3 py-1 rounded-full text-xs font-semibold font-mono border border-accent/30">GitHub</span>
          </div>
        </div>
        {/* About & Skills with code block style */}
        <div className="flex flex-col gap-8">
          <h2 className="text-3xl font-bold mb-2 text-accent font-mono">About Me</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-2 text-accent font-mono">Tech Stack</h3>
              <ul className="flex flex-wrap gap-2 mb-4">
                <li className="bg-primary-900 text-accent px-3 py-1 rounded-full text-xs font-mono border border-accent/30">Python</li>
                <li className="bg-primary-900 text-accent px-3 py-1 rounded-full text-xs font-mono border border-accent/30">Prompt Engineering</li>
                <li className="bg-primary-900 text-accent px-3 py-1 rounded-full text-xs font-mono border border-accent/30">Git</li>
                <li className="bg-primary-900 text-accent px-3 py-1 rounded-full text-xs font-mono border border-accent/30">GitHub</li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-2 text-accent font-mono">Core Skills</h3>
