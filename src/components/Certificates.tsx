    ...
    <section id="certificates" className="py-28 bg-gradient-to-b from-primary-950 via-primary-900 to-primary-950 text-primary-100">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-accent mb-3 font-mono tracking-tight">Certificates</h2>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          {certificates.map((cert, idx) => (
            <div key={idx} className="bg-primary-900 rounded-2xl shadow-2xl border border-primary-700 p-6 flex flex-col items-center group">
              <div className="w-full h-56 flex items-center justify-center mb-4 overflow-hidden rounded-xl border border-accent bg-primary-950">
                <img
                  src={cert.image}
                  alt={cert.title}
              ...
              <h3 className="text-xl font-bold text-accent mb-1 font-mono text-center">{cert.title}</h3>
